...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../libs/emoji.json":[function(require,module,exports) {
module.exports = {
  "grinning": {
...
},{}],"../libs/assertEmoji.js":[function(require,module,exports) {
"use strict";
...
var assertEmoji = function assertEmoji(text) {
  return distribute(text, mode);
};

var _default = assertEmoji;
exports.default = _default;
},{}],"../libs/index.js":[function(require,module,exports) {
"use strict";
...
var _assertEmoji = _interopRequireDefault(require("./assertEmoji"));
...
/*#__PURE__*/
function () {
  function EmojiLib(validator) {
    _classCallCheck(this, EmojiLib);

    this.validator = validator; // this.ordered = ordered;
  ...
  _createClass(EmojiLib, [{
    key: "createLibary",
    value: function createLibary() {
      for (var key in _emoji.default) {
        if ((0, _assertEmoji.default)(_emoji.default[key].char)) {
          if (this.validator && !this.validator(_emoji.default[key])) continue;
          this.libs[key] = _emoji.default[key];

          if (this.classify[_emoji.default[key].category]) {
            this.classify[_emoji.default[key].category][key] = _emoji.default[key];
          } else {
            this.classify[_emoji.default[key].category] = _defineProperty({}, key, _emoji.default[key]);
          }
        }
      }
    }
    ...
    key: "category",
    value: function category(categorys) {
...
var _default = EmojiLib;
exports.default = _default;
},{"./emoji":"../libs/emoji.json","./assertEmoji":"../libs/assertEmoji.js"}],"demo.js":[function(require,module,exports) {
"use strict";
...
var emoji = new _index.default();
console.log(emoji);
var text = '';
Object.keys(emoji.libs).forEach(function (key) {
  text += "<li>".concat(emoji.libs[key].char, "</li>");
});
list.innerHTML = text;
...
},{"../libs/index.js":"../libs/index.js"}],"../../../.config/yarn/global/node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../.config/yarn/global/node_modules/parcel/src/builtins/hmr-runtime.js","demo.js"], null)
